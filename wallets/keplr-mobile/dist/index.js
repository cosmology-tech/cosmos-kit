...
__export(src_exports, {
  ChainKeplrMobile: () => ChainKeplrMobile,
  KeplrMobileWallet: () => KeplrMobileWallet,
  keplrMobileInfo: () => keplrMobileInfo,
  wallets: () => wallets
});
...
var KeplrClient = class extends import_walletconnect.WCClient {
...
// src/wallet-connect/chain-wallet.ts
var ChainKeplrMobile = class extends import_walletconnect2.ChainWC {
...
var KeplrMobileWallet = class extends import_walletconnect3.WCWallet {
...
// src/keplr.ts
var keplrMobile = new KeplrMobileWallet(keplrMobileInfo, preferredEndpoints);
var wallets = [keplrMobile];
