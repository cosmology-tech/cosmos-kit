...
// src/web3auth.ts
var web3auth_exports = {};
__export(web3auth_exports, {
  wallets: () => wallets
});
module.exports = __toCommonJS(web3auth_exports);
...
// src/web3auth.ts
var web3AuthWallet = new Web3AuthWallet(web3AuthWalletInfo);
var wallets = [web3AuthWallet];
