...
var ChainStationExtension = class extends ChainWalletBase {
...
var getStationFromExtension = async () => {
  ...
  const stationExtension2 = new StationExtension();
  await stationExtension2.init();
  return stationExtension2;
};

// src/extension/main-wallet.ts
var StationExtensionWallet = class extends MainWalletBase {
...
// src/station.ts
var stationExtension = new StationExtensionWallet(stationExtensionInfo);
var wallets = [stationExtension];
export {
  wallets
};
//# sourceMappingURL=station.mjs.map