...
| **walletconnect** | `{ name: string; projectId: string }`   | only required when you are using `@cosmos-kit/walletconnect` |
...
- [Keplr Extension - Wallet Info](https://github.com/cosmology-tech/cosmos-kit/tree/develop/wallets/keplr-extension/src/extension/registry.ts)

- [Keplr Mobile - Wallet Info](https://github.com/cosmology-tech/cosmos-kit/tree/develop/wallets/keplr-extension/src/wallet-connect/registry.ts)
...
| **getOfflineSigner**   | `(chainId: string) => Promise<OfflineSigner>`   | if `isNanoLedger` or indefinite, will return `OfflineAminoSigner`, else return `OfflineDirectSigner` |
...
- [Keplr Extension - Chain Wallet](https://github.com/cosmology-tech/cosmos-kit/tree/develop/wallets/keplr-extension/src/extension/chain-wallet.ts)
...
- [Keplr Extension - Main Wallet](https://github.com/cosmology-tech/cosmos-kit/tree/develop/wallets/keplr-extension/src/extension/main-wallet.ts)
