...
| **getRpcEndpoint** | return rpc endpoint, `isLazy` explanation is [here](/chain-provider#isLazy)    | **isLazy**?: `boolean` | `string \| ExtendedHttpEndpoint` | Y |
| **getRestEndpoint**  | return rest endpoint, `isLazy` explanation is [here](/chain-provider#isLazy)    | **isLazy**?: `boolean` | `string \| ExtendedHttpEndpoint` | Y |
