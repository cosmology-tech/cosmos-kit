# Integrating wallets in FOUR steps
...
Last but not least, append this instance to the `wallets` property of [CosmosProvider](https://docs.cosmoskit.com/get-started#provider).
