...
| **signAmino**  | using `wallet client` |   **signer**: string,<br />**signDoc**: StdSignDoc,<br />**signOptions**?: SignOptions | `AminoSignResponse \| undefined` | Y |
| **signDirect**  | using `wallet client` |   **signer**: string,<br />**signDoc**: StdSignDoc,<br />**signOptions**?: SignOptions | `DirectSignResponse \| undefined` | Y |
