...
export default {
  footer: {
    ...
    text: <span>🛠 Built by Cosmology — if you like our tools, please consider delegating to <a href="https://cosmology.tech/validator" target="_blank" rel="noreferrer" aria-selected="false" className="nx-text-primary-500 nx-underline nx-decoration-from-font [text-underline-position:under]">our validator ⚛️</a></span>,
  },
  chat: {
