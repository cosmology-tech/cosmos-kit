...
export declare const SimpleInstallWalletButtonV1: ({ icon, text, }: DownloadWalletButtonType) => JSX.Element;
...
export declare const SimpleDisplayWalletListV1: ({ initialFocus, walletsData, handleClick, }: DisplayWalletListType) => JSX.Element;
