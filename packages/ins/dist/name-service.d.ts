...
declare type NameServiceRegistry = NameServiceInfo[];
declare type ParsedInsName = {
    name: string;
    resolver: string;
    nameservice: string;
} | undefined;
 ...
 **/
declare const parseINSName: (name: string) => ParsedInsName;
/**
...
export { INS, NameServiceInfo, NameServiceName, NameServiceRegistry, ParsedInsName, parseINSName };
