...
var ChainProvider = ({
  ...
  const logger = (0, import_react.useMemo)(() => new import_core.Logger(logLevel), []);
  const walletManager = (0, import_react.useMemo)(
    () => new import_core.WalletManager(
      chains,
      assetLists,
      wallets,
      logger,
  ...
  const [isViewOpen, setViewOpen] = (0, import_react.useState)(false);
  const [viewWalletRepo, setViewWalletRepo] = (0, import_react.useState)();
  const [, setData] = (0, import_react.useState)();
  const [, setState] = (0, import_react.useState)(import_core.State.Init);
  const [, setMsg] = (0, import_react.useState)();
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    walletContext.Provider,
    {
      ...
      children: [
        ProvidedWalletModal && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          ProvidedWalletModal,
          {
            isOpen: isViewOpen,
            setOpen: setViewOpen,
