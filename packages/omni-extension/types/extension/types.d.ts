...
export interface OmniSignOptions {
...
export interface Omni {
    ...
    signAmino(chainId: string, signer: string, signDoc: StdSignDoc, signOptions?: OmniSignOptions): Promise<AminoSignResponse>;
    ...
    }, signOptions?: OmniSignOptions): Promise<DirectSignResponse>;
