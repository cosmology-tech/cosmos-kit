...
import { WalletClient, Wallet, WalletClientActions, Mutable, AppUrl, Logger, WalletConnectOptions, DappEnv, SimpleAccount, State, SignType, WalletAccount, SignOptions, DirectSignDoc } from '@cosmos-kit/core';
import SignClient from '@walletconnect/sign-client';
import { PairingTypes, SessionTypes } from '@walletconnect/types';
import EventEmitter from 'events';

declare class WCClient implements WalletClient {
